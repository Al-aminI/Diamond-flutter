...
class StakeHistoryPage extends StatefulWidget {
  final String userId;
  const StakeHistoryPage({super.key, required this.userId});

  @override
  State<StakeHistoryPage> createState() => _StakeHistoryPageState();
}

class _StakeHistoryPageState extends State<StakeHistoryPage> {
  Future<List<Map<String, dynamic>>> getTeam() async {
    final Map<String, dynamic> requestData = {'user_id': widget.userId};

    final url = Uri.parse('http://127.0.0.1:5000/get_stake');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Stake History"),
        ),
        //drawer: MyDrawer(
